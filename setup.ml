...
(* OASIS_START *)
(* DO NOT EDIT (digest: 63c6b38d21587367c52189b35cbcafdd) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "nvml";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "functional_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "nvml"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "functional_test.ml"})
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\181\254\136S\210W<\184A\180\128\173s\146\1382";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
